...
class Filesystem():
    ...
    def smallest_size_of_dir_to_delete(self):
        SIZE_OF_UPDATE = 30000000
        TOTAL_DISK_SPACE = 70000000
        curr_disk_space_used = self.directory_sizes["/"]
        free_disk_space = TOTAL_DISK_SPACE - curr_disk_space_used

        return min(dir_size for dir_size in self.directory_sizes.values() if free_disk_space + dir_size >= SIZE_OF_UPDATE)


f = Filesystem("./input")
print(f.smallest_size_of_dir_to_delete())
